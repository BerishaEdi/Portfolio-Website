  ...
  return (
    <div>
        ...
        <div class="grid">
          ...
          <div class="div1"> 
            <a className='calculatorLink' href="https://portfolio.bbbaden.ch/user/e-berisha-inf20/la-1305-react-nativ-taschenrechner">React-Native <br></br> Taschenrechner</a>
